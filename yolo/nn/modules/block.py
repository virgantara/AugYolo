...
from .conv import Conv, DOConv2d, DWConv, GhostConv, LightConv, RepConv, autopad
...
class C2fDO(nn.Module):
    ...
    def __init__(self, c1: int, c2: int, n: int = 1, shortcut: bool = False, g: int = 1, e: float = 0.5):
        ...
        self.m = nn.ModuleList(BottleneckDO(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
...
class BottleneckDO(nn.Module):
    # Sama seperti Bottleneck, tapi conv 3x3 pakai DOConv2d (1x1 tetap Conv biasa)
    def __init__(self, c1, c2, shortcut=True, g=1, k=(1, 3), e=0.5):
        super().__init__()
        c_ = int(c2 * e)
        self.cv1 = Conv(c1, c_, k[0], 1)                  # 1x1 tetap Conv
        self.cv2 = DOConv2d(c_, c2, k[1], 1, g=g)         # 3x3 jadi DOConv2d
        self.add = shortcut and c1 == c2
